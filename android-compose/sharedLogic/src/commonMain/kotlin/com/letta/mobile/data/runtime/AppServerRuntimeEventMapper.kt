...
open class AppServerRuntimeEventMapper {
    open fun map(command: TurnCommand, received: AppServerReceivedFrame): List<RuntimeEventDraft> =
        when (val frame = received.frame) {
            ...
            is AppServerInboundFrame.ListConnectProvidersResponse,
            is AppServerInboundFrame.ConnectProviderResponse,
            is AppServerInboundFrame.DisconnectProviderResponse,
            is AppServerInboundFrame.UpdateModelResponse,
