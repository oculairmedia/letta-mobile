...
class ChatMotionTest {
    ...
    private fun locateSource(fileName: String): File {
        val candidates = listOf(
            "app/src/main/java/com/letta/mobile/ui/screens/chat/$fileName",
            "android-compose/app/src/main/java/com/letta/mobile/ui/screens/chat/$fileName",
            "../app/src/main/java/com/letta/mobile/ui/screens/chat/$fileName",
        )
        ...
        repeat(6) {
            ...
            val match = current.walkTopDown()
                .firstOrNull { it.isFile && it.name == fileName && it.path.contains("/screens/chat/") }
