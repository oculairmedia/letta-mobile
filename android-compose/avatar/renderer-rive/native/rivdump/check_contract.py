...
def _problems(want_props, have_props, want_machine, have_machines, enums, want_state_keys, want_shape_keys):
    problems = []
...
def main(argv=None):
    ...
    problems = _problems(want_props, have_props, want_machine, have_machines, enums, want_state_keys, want_shape_keys)
    if problems:
