 ...
 *
 * Selects Iroh QUIC, local NoOp, or WebSocket based on the active config —
 * the same scheme detection SessionScoped consumers already rely on.
 */
@Singleton
