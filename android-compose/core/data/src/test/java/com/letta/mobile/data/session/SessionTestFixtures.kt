...
internal fun createTestSessionGraphFactory(
    agentApi: FakeAgentApi = FakeAgentApi(),
    agentDao: FakeAgentDao = FakeAgentDao(),
    conversationApi: FakeConversationApi = FakeConversationApi(),
    conversationDao: FakeConversationDao = FakeConversationDao(),
    archiveApi: FakeArchiveApi = FakeArchiveApi(),
    folderApi: FakeFolderApi = FakeFolderApi(),
    groupApi: FakeGroupApi = FakeGroupApi(),
    identityApi: FakeIdentityApi = FakeIdentityApi(),
    lettaApiClient: LettaApiClient = fakeLettaApiClient(),
    mcpServerApi: FakeMcpServerApi = FakeMcpServerApi(),
    modelApi: FakeModelApi = FakeModelApi(),
    passageApi: FakePassageApi = FakePassageApi(),
    projectApi: FakeProjectApi = FakeProjectApi(),
    projectWorkApi: FakeProjectWorkApi = FakeProjectWorkApi(),
    runApi: FakeRunApi = FakeRunApi(),
    jobApi: FakeJobApi = FakeJobApi(),
    providerApi: FakeProviderApi = FakeProviderApi(),
    scheduleApi: FakeScheduleApi = FakeScheduleApi(),
    stepApi: FakeStepApi = FakeStepApi(),
    toolApi: FakeToolApi = FakeToolApi(),
    settingsRepository: FakeSettingsRepository? = null,
